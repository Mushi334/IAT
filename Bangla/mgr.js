define(['managerAPI',
	...
	init_data_pipe(API, 'TKhpgBSAVeEo',  {file_type:'csv'});	
    ...
    API.addTasksSet({
        ...
        raceiat_instructions: [{
            ...
            header: 'ইম্প্লিসিট অ্যাসোসিয়েশন টেস্ট'
        }],
        ...
        lastpage: [{
            ...
            //last:true, 
            header: 'আপনি গবেষণাটি সম্পন্ন করেছেন'
        }], 
        ...
        [{ 
            ...
            type:'redirect', name:'redirecting', url: 'https://qualtricsxm4c6wr5n3j.qualtrics.com/jfe/form/SV_3JBhiVrB8xZsArI' 
        }],
		
		//This task waits until the data are sent to the server.
        uploading: uploading_task({header: 'একটু অপেক্ষা করুন', body:'অনুগ্রহ করে অপেক্ষা করুন, তথ্য পাঠানো হচ্ছে... '})
    });
