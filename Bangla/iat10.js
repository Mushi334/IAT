	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			finalText : 'পরের অংশে যেতে স্পেসবার চাপুন', 
			finalTouchText : 'পরের অংশে যেতে নিচের সবুজ অংশে ট্যাপ করুন',
			...
			instAttributePractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'<font color="#000000">বাম হাতের আঙুল দিয়ে <b>E</b> কী চাপুন যদি আইটেমটি <font color="#0000ff">leftAttribute</font> বিভাগের হয়।</font>' +
				'<br/>ডান হাতের আঙুল দিয়ে <b>I</b> কী চাপুন যদি আইটেমটি <font color="#0000ff">rightAttribute</font> বিভাগের হয়।<br/><br/>' +
				'ভুল হলে লাল <font color="#ff0000"><b>X</b></font> দেখাবে। ' +
				'সঠিক কী চাপুন।<br/>' +
			...
			instAttributePracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'বাম হাতের আঙুল <b>বাম</b> সবুজ অংশে রাখুন যদি আইটেমটি এই বিভাগের হয়: <font color="#0000ff">leftAttribute</font>.<br/>',
						'ডান হাতের আঙুল <b>ডান</b> সবুজ অংশে রাখুন যদি আইটেমটি এই বিভাগের হয়: <font color="#0000ff">rightAttribute</font>.<br/>',
						'আইটেমগুলো একে একে দেখাবে।<br/>',
						'<br/>',
						'ভুল হলে লাল <font color="#ff0000"><b>X</b></font> দেখাবে। অন্য পাশে ট্যাপ করুন। <u>যত দ্রুত পারেন</u> সঠিকভাবে উত্তর দিন।',
					'</p>',
					'<p align="center">শুরু করতে নিচের সবুজ অংশে ট্যাপ করুন।</p>',
				'</div>'
			].join('\n'),
			...
			instCategoriesPracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'বাম হাতের আঙুল <b>বাম</b> সবুজ অংশে রাখুন যদি আইটেমটি এই বিভাগের হয়: <font color="#336600">leftCategory</font>.<br/>',
						'ডান হাতের আঙুল <b>ডান</b> সবুজ অংশে রাখুন যদি আইটেমটি এই বিভাগের হয়: <font color="#336600">rightCategory</font>.<br/>',
						'আইটেমগুলো একে একে দেখাবে।<br/>',
						'<br/>',
						'ভুল হলে লাল <font color="#ff0000"><b>X</b></font> দেখাবে। অন্য পাশে ট্যাপ করুন। <u>যত দ্রুত পারেন</u> সঠিকভাবে উত্তর দিন।',
					'</p>',
			...
			instFirstCombinedTouch:[
				'<div>',
					...
					'<br/>',
					'<p align="left" style="margin-left:5px">',
						'বাম হাতের আঙুল <b>বাম</b> সবুজ অংশে রাখুন <font color="#336600">leftCategory</font> items and for <font color="#0000ff">leftAttribute</font>.</br>',
						'ডান হাতের আঙুল <b>ডান</b> সবুজ অংশে রাখুন <font color="#336600">rightCategory</font> items and for <font color="#0000ff">rightAttribute</font>.</br>',
							'ভুল হলে লাল <font color="#ff0000"><b>X</b></font> দেখাবে। অন্য পাশে ট্যাপ করুন। <u>যত দ্রুত পারেন</u> সঠিকভাবে উত্তর দিন।</br>',
						'</p>',
						'<p align="center">শুরু করতে নিচের সবুজ অংশে ট্যাপ করুন।</p>',
				'</div>'
			].join('\n'),
			...
			instSecondCombinedTouch:[
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						...
						'ডান হাতের আঙুল <b>ডান</b> সবুজ অংশে রাখুন <font color="#336600">rightCategory</font> items and for <font color="#0000ff">rightAttribute</font>.<br/>',
						'<br/>',
						'<u>যত দ্রুত পারেন</u> সঠিকভাবে উত্তর দিন।<br/>',
					'</p>',
					'<p align="center">শুরু করতে নিচের সবুজ অংশে ট্যাপ করুন।</p>',
				'</div>'
			].join('\n'),
			...
			instSwitchCategories : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'বাম হাতের আঙুল দিয়ে <b>E</b> কী চাপুন <font color="#336600">leftCategory</font> এর জন্য।<br/>' +
				'ডান হাতের আঙুল দিয়ে <b>I</b> কী চাপুন <font color="#336600">rightCategory</font> এর জন্য।<br/><br/>' +
				'<u>যত দ্রুত পারেন</u> সঠিকভাবে উত্তর দিন।<br/><br/></p>' +
				'<p align="center">শুরু করতে <b>স্পেসবার</b> চাপুন।</font></p></div>',
			instSwitchCategoriesTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'সতর্ক থাকুন, লেবেলের অবস্থান পরিবর্তন হয়েছে!<br/>',
							'বাম হাতের আঙুল <b>বাম</b> সবুজ অংশে রাখুন <font color="#336600">leftCategory</font> items.<br/>',
							'ডান হাতের আঙুল <b>ডান</b> সবুজ অংশে রাখুন <font color="#336600">rightCategory</font> items.<br/>',
							'আইটেমগুলো একে একে দেখাবে।',
							'<br/>',
							'ভুল হলে লাল <font color="#ff0000"><b>X</b></font> দেখাবে। অন্য পাশে ট্যাপ করুন। <u>যত দ্রুত পারেন</u> সঠিকভাবে উত্তর দিন।<br/>',
						'</p>',
						'<p align="center">শুরু করতে নিচের সবুজ অংশে ট্যাপ করুন।</p>',
			...
			manyErrors: 'অনেক বেশি ভুল হয়েছে, ফলাফল নির্ধারণ করা সম্ভব হয়নি।',
			tooFast: 'অনেক বেশি দ্রুত উত্তর দেওয়া হয়েছে, ফলাফল নির্ধারণ করা সম্ভব হয়নি।',
			notEnough: 'পর্যাপ্ত ট্রায়াল ছিল না, ফলাফল নির্ধারণ করা সম্ভব হয়নি।'
		};
