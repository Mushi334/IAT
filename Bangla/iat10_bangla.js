	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			finalText : 'পরবর্তী অংশে যেতে স্পেসবার চাপুন', 
			finalTouchText : 'পরবর্তী অংশে যেতে নিচের সবুজ অংশে স্পর্শ করুন',
			...
			instAttributePractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'<b>E</b> কী-তে বাম আঙুল রাখুন যেসব আইটেম <font color="#0000ff">leftAttribute</font> বিভাগের।' +
				'<br/><b>I</b> কী-তে ডান আঙুল রাখুন যেসব আইটেম <font color="#0000ff">rightAttribute</font> বিভাগের।<br/><br/>' +
				'If you make a mistake, a red <font color="#ff0000"><b>X</b></font> will appear. ' +
				'অন্য কী চাপুন।<br/>' +
				'<u>যত দ্রুত সম্ভব</u> সঠিকভাবে উত্তর দিন।<br/><br/></p>'+
				'<p align="center">শুরু করতে প্রস্তুত হলে <b>স্পেসবার</b> চাপুন।</font></p></div>',
			instAttributePracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'বাম সবুজ অংশে বাম আঙুল রাখুন যেসব আইটেম <font color="#0000ff">leftAttribute</font> বিভাগের।<br/>',
						'ডান সবুজ অংশে ডান আঙুল রাখুন যেসব আইটেম <font color="#0000ff">rightAttribute</font> বিভাগের।<br/>',
						'একটি একটি করে আইটেম দেখানো হবে।<br/>',
						'<br/>',
						'যদি আপনি ভুল করেন, একটি লাল <font color="#ff0000"><b>X</b></font> দেখা যাবে। অন্য পাশে স্পর্শ করুন। <u>যত দ্রুত সম্ভব</u> সঠিকভাবে উত্তর দিন।',
					'</p>',
					'<p align="center">শুরু করতে নিচের <b>সবুজ</b> অংশে স্পর্শ করুন।</p>',
				'</div>'
			].join('\n'),
			...
			instCategoriesPractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>অংশ blockNum এর মধ্যে nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'<b>E</b> কী-তে বাম আঙুল রাখুন যেসব আইটেম <font color="#336600">leftCategory</font> বিভাগের। ' +
				'<br/><b>I</b> কী-তে ডান আঙুল রাখুন যেসব আইটেম <font color="#336600">rightCategory</font> বিভাগের।<br/>' +
				'একটি একটি করে আইটেম দেখানো হবে।<br/><br/>' +
				'If you make a mistake, a red <font color="#ff0000"><b>X</b></font> will appear. ' +
				'অন্য কী চাপুন।<br/>' +
				'<u>যত দ্রুত সম্ভব</u> সঠিকভাবে উত্তর দিন।<br/><br/></p>'+
				'<p align="center">শুরু করতে প্রস্তুত হলে <b>স্পেসবার</b> চাপুন।</font></p></div>',
			instCategoriesPracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'বাম সবুজ অংশে বাম আঙুল রাখুন যেসব আইটেম <font color="#336600">leftCategory</font> বিভাগের।<br/>',
						'ডান সবুজ অংশে ডান আঙুল রাখুন যেসব আইটেম <font color="#336600">rightCategory</font> বিভাগের।<br/>',
						'একটি একটি করে আইটেম দেখানো হবে।<br/>',
						'<br/>',
						'যদি আপনি ভুল করেন, একটি লাল <font color="#ff0000"><b>X</b></font> দেখা যাবে। অন্য পাশে স্পর্শ করুন। <u>যত দ্রুত সম্ভব</u> সঠিকভাবে উত্তর দিন।',
					'</p>',
			...
			instFirstCombinedTouch:[
				'<div>',
					...
					'<br/>',
					'<p align="left" style="margin-left:5px">',
						'বাম সবুজ অংশে বাম আঙুল রাখুন <font color="#336600">leftCategory</font> এবং <font color="#0000ff">leftAttribute</font> এর জন্য।</br>',
						'ডান সবুজ অংশে ডান আঙুল রাখুন <font color="#336600">rightCategory</font> এবং <font color="#0000ff">rightAttribute</font> এর জন্য।</br>',
							'যদি আপনি ভুল করেন, একটি লাল <font color="#ff0000"><b>X</b></font> দেখা যাবে। অন্য পাশে স্পর্শ করুন। <u>যত দ্রুত সম্ভব</u> সঠিকভাবে উত্তর দিন।</br>',
						'</p>',
						'<p align="center">শুরু করতে নিচের <b>সবুজ</b> অংশে স্পর্শ করুন।</p>',
				'</div>'
			].join('\n'),
			...
			instSecondCombinedTouch:[
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						...
						'ডান সবুজ অংশে ডান আঙুল রাখুন <font color="#336600">rightCategory</font> এবং <font color="#0000ff">rightAttribute</font> এর জন্য।<br/>',
						'<br/>',
						'<u>যত দ্রুত সম্ভব</u> সঠিকভাবে উত্তর দিন।<br/>',
					'</p>',
					'<p align="center">শুরু করতে নিচের <b>সবুজ</b> অংশে স্পর্শ করুন।</p>',
				'</div>'
			].join('\n'),
			...
			instSwitchCategories : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>অংশ blockNum এর মধ্যে nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'<b>সতর্ক থাকুন, লেবেলগুলির অবস্থান পরিবর্তন হয়েছে!</b><br/>' +
				'বাম আঙুল দিয়ে <b>E</b> কী চাপুন <font color="#336600">leftCategory</font> এর জন্য।<br/>' +
				'ডান আঙুল দিয়ে <b>I</b> কী চাপুন <font color="#336600">rightCategory</font> এর জন্য।<br/><br/>' +
				'<u>যত দ্রুত সম্ভব</u> সঠিকভাবে উত্তর দিন।<br/><br/></p>' +
				'<p align="center">শুরু করতে প্রস্তুত হলে <b>স্পেসবার</b> চাপুন।</font></p></div>',
			instSwitchCategoriesTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'সতর্ক থাকুন, লেবেলগুলির অবস্থান পরিবর্তন হয়েছে!<br/>',
							'বাম সবুজ অংশে বাম আঙুল রাখুন <font color="#336600">leftCategory</font> এর জন্য।<br/>',
							'ডান সবুজ অংশে ডান আঙুল রাখুন <font color="#336600">rightCategory</font> এর জন্য।<br/>',
							'একটি একটি করে আইটেম দেখানো হবে।',
							'<br/>',
							'যদি আপনি ভুল করেন, একটি লাল <font color="#ff0000"><b>X</b></font> দেখা যাবে। অন্য পাশে স্পর্শ করুন। <u>যত দ্রুত সম্ভব</u> সঠিকভাবে উত্তর দিন।<br/>',
						'</p>',
						'<p align="center">শুরু করতে নিচের <b>সবুজ</b> অংশে স্পর্শ করুন।</p>',
			...
			fb_strong_Att1WithCatA_Att2WithCatB : "'categoryA'-কে 'attribute1' এবং 'categoryB'-কে 'attribute2' এর সাথে সাজাতে আপনি অনেক দ্রুত ছিলেন",
			fb_moderate_Att1WithCatA_Att2WithCatB : "'categoryA'-কে 'attribute1' এবং 'categoryB'-কে 'attribute2' এর সাথে সাজাতে আপনি মাঝামাঝি দ্রুত ছিলেন",
			fb_slight_Att1WithCatA_Att2WithCatB : "'categoryA'-কে 'attribute1' এবং 'categoryB'-কে 'attribute2' এর সাথে সাজাতে আপনি সামান্য দ্রুত ছিলেন",
			fb_equal_CatAvsCatB : "উভয় ক্ষেত্রে আপনার গতি প্রায় সমান ছিল।",

			//Error messages in the feedback
			manyErrors: 'ফলাফল নির্ধারণ করতে অনেক বেশি ভুল হয়েছে।',
			tooFast: 'ফলাফল নির্ধারণ করতে অনেক বেশি দ্রুত উত্তর দেওয়া হয়েছে।',
			notEnough: 'ফলাফল নির্ধারণ করতে যথেষ্ট উত্তর পাওয়া যায়নি।'
		};
