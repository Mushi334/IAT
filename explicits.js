...
//Image questions
    API.addQuestionsSet('imageRating1', {
        inherit: 'basicSelect',
        name: 'imageRating1',
        stem: '<div style="text-align:center;"><img src="https://github.com/Mushi334/IAT/blob/main/images/female_lab.png?raw=true" style="max-width:40%; margin-bottom:15px;"></div>How typical does this image seem to you?',
        answers: [
    ...
    API.addQuestionsSet('imageRating2', {
        inherit: 'basicSelect',
        name: 'imageRating2',
        stem: '<div style="text-align:center;"><img src="https://github.com/Mushi334/IAT/blob/main/images/male_lab.png?raw=true" style="max-width:40%; margin-bottom:15px;"></div>How typical does this image seem to you?',
        answers: [
            { text: '1 - Not at all typical', value: 1 },
            { text: '2', value: 2 },
            { text: '3', value: 3 },
